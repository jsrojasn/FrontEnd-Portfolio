  ...
  <div className="about">
    ...
    <div className="content-container">
      <div className="about-content">
        ...
        <p className="resume">Hi, my name is Juan Sebastian Rojas. I'm an enthusiastic Front-End Web Developer from Bogota, Colombia. My goal is to become a Full-Stack- Web Developer and make real ideas from all around the world.</p>
      ...
      <div className="profile">
        ...
        <div className="social">
          <a href="https://github.com/jsrojasn"><img src="images/github.png"></img></a>
          <a href="https://www.linkedin.com/in/juan-sebastian-rojas-navia-aa727b159/"><img src="images/linkedin.png"></img></a>
          <a href="https://www.instagram.com/jsrojasn91/"><img src="images/instagram.png"></img></a>
        </div>
      </div>
    </div>
  </div>
